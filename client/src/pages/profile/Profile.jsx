...
function Profile({ posts, openRightbar }) {
    ...
    const handleFollow = (type) => {
        const fecthFollow = async () => {
            try {
                if (currentUser.flowing?.includes(paramId.userId)) {
                    await axiosInstance.put(`/user/unfollow/${paramId.userId}`);
                    await axiosInstance.delete(`/notification/del/${paramId.userId}/3`);
                } else {
                        ...
                        <div className="profile-top">
                            <div className="background">
                                <img
                                    ...
                                    src={user.userCoverImg || noBg}
                                    alt={user.userCoverImg}
                                />
                            ...
                            <div className="btn-fl">
                                ...
                                {currentUser._id === paramId.userId ? (
                                    ...
                                    <button className="follow2" onClick={() => handleFollow(3)}>
                            ...
                            <div className="profile-mid">
                                <Link to={`/following/${user._id}`} style={{ textDecoration: 'none' }}>
                                    <p className="following-count">
                                        <span>{user.followUser}</span>following
                                    </p>
                                </Link>
                                <Link to={`/follower/${user._id}`} style={{ textDecoration: 'none' }}>
                                    <p className="follower-count">
                                        <span>{user.follower?.length} </span>follower
                                    </p>
                                </Link>

                                <p className="post-count">
                                    <span>{user.postCount} </span>post
                                </p>
                            </div>
                        </div>
                                ...
                                <div className="introduce-item">
                                    ...
                                    <div className="desc">
                                        <p className="desc-text">
                                            {user.descProfile ? user.descProfile : 'Write somethings about you'}
                                        </p>
                                        {openEditDesc ? (
                                            <div className="edit">
                                                <textarea
                                                ...
                                                <div className="edit-desc">
                                                    ...
                                                    <button className="update-btn" onClick={handleUpdateDesc}>
                                                        {' '}
                                                        Update
                                                    </button>
                                                </div>
                                        ...
                                        <div className="info-item">
                                            <div className="info-icon">
                                                ...
                                                <div className="veryfire">
                                                    <p>{user.email}</p>
                                                    {user.emailVerified ? (
                                                        <span style={{ color: 'rgb(18, 207, 62)' }}>
                                            ...
                                            <Link to={`/setting`} style={{ textDecoration: 'none' }}>
                                                {currentUser._id === paramId.userId ? (
                                                    <button className="info-btn">SETTING</button>
                                                ) : (
                                                    <></>
                                                )}
                                            </Link>
                                    ...
                                    <>
                                        <div className="friend-container">
                                            <Link to={`/friend/${user._id}`} style={{ textDecoration: 'none' }}>
                                                <h1 className="friend">
                                                    FRIENDS <span>{user.friend?.length}</span>
                                                </h1>
                                            </Link>
                                            <div className="other">
